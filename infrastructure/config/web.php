    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'admin/activity-log/export-csv' => 'admin/activity-log/export-csv',
                ...
                'admin/receiving/create'                   => 'admin/receiving/create',
                'admin/receiving/products'                 => 'admin/receiving/products',
                'admin/receiving/add-item'                 => 'admin/receiving/add-item',
                'admin/receiving/update-item'              => 'admin/receiving/update-item',
                'admin/receiving/remove-item'              => 'admin/receiving/remove-item',
                'admin/receiving/add-expense'              => 'admin/receiving/add-expense',
                ...
                'admin/receiving/upload-document'          => 'admin/receiving/upload-document',
                'admin/receiving/delete-document'          => 'admin/receiving/delete-document',
                'admin/receiving/from-buyout/<buyoutId:\d+>' => 'admin/receiving/from-buyout',
                'admin/receiving/<id:\d+>'                 => 'admin/receiving/view',
                'admin/receiving/<id:\d+>/update'          => 'admin/receiving/update',
