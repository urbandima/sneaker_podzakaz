...
$galleryImages = ProductCardHelper::buildGalleryImages($product, ProductCardHelper::LAZY_PLACEHOLDER);
$mainImage = $galleryImages[0] ?? ProductCardHelper::LAZY_PLACEHOLDER;
$thumbImages = array_slice($galleryImages, 0, ProductCardHelper::MAX_GALLERY_IMAGES);

$sizeField = ProductCardHelper::resolveSizeField(ProductCardHelper::DEFAULT_SIZE_SYSTEM);
$sizeBadges = ProductCardHelper::prepareSizeBadges($product, $sizeField, []);
$priceView = ProductCardHelper::calculatePriceView($product, null, [], $sizeField);
                ...
                <div class="qv-thumbs">
                    <?php foreach ($thumbImages as $index => $imgUrl): ?>
                        <img
                            ...
                            onclick="changeQvImg('<?= Html::encode($imgUrl) ?>', this)">
                    <?php endforeach; ?>
                </div>
            <?php endif; ?>
        </div>
