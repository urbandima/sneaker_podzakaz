...
class Brand extends ActiveRecord
{
    ...
    public function behaviors()
    {
        return [
            ...
            [
                ...
                // Как и в Category (CMP-417): 'name' напрямую не годится, потому что
                // yii\helpers\Inflector::transliterate() без php-intl не переводит
                // кириллицу и slug() вырезает все кириллические буквы регэкспом —
                // бренд с чисто кириллическим названием получал slug = '' /
                // '-2' и становился недостижим на /catalog/brand/{slug}.
                // getSlugSource() транслитерирует кириллицу вручную перед тем,
    ...
    /**
     * Кириллическая карта транслитерации, см. аналогичное поле в Category (CMP-417).
