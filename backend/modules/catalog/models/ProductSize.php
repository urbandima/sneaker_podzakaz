...
/**
 * ProductSize — Модель размера товара
 * 
 * НАЗНАЧЕНИЕ:
 * Размеры товара с остатками и ценами: поддержка разных
 * систем размеров (EU, US, UK, CM), интеграция с Poizon.
 * 
 * ОСНОВНЫЕ СВОЙСТВА:
 * - product_id: ID товара
 * - size: размер (40, 41, S, M, L, XL)
 * - stock: остаток на складе
 * - is_available: доступен для заказа
 * - price: цена размера (если отличается)
 * 
 * СИСТЕМЫ РАЗМЕРОВ:
 * - us_size: размер US
 * - eu_size: размер EU
 ...
 * - poizon_price_cny: цена на Poizon
 * 
 * СВЯЗИ:
 * - Product (принадлежит товару)
 * - SizeGridItem (связь с размерной сеткой)
 * 
 * ИСПОЛЬЗОВАНИЕ:
 * - CatalogController (выбор размера при заказе)
 * - ProductController/admin (управление размерами)
 * - Фильтрация по размерам в каталоге
 */
