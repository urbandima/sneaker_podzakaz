                ...
                <div class="control-header flex-between">
                    ...
                    if ($dpShipmentId) {
                        ...
                        if (in_array($dpStatus, ['problem','customs_hold','returned'])) {
                            $badgeStyle = 'background:#dc3545;color:#fff;font-size:11px;padding:2px 8px;border-radius:10px';
                            $badgeText = 'Ошибка';
                        } elseif ($dpStatus === 'delivered') {
                            $badgeText = 'Доставлен';
                        }
                    } else {
                        $badgeStyle = 'background:#6b7280;color:#fff;font-size:11px;padding:2px 8px;border-radius:10px';
