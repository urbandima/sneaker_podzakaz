...
/** @var app\backend\modules\catalog\models\ProductSize $size */

$this->title = 'Добавить размер: ' . $product->name;
...
$this->params['breadcrumbs'][] = 'Добавить размер';
?>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-3">
                    <?= $form->field($size, 'us_size')->textInput([
                        'placeholder' => '9.5'
                    ])->label('US размер <span class="text-danger">*</span>', ['encode' => false]) ?>
                </div>
                <div class="col-md-3">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    ])->label('Размер (общее обозначение) <span class="text-danger">*</span>', ['encode' => false]) ?>
                </div>
                <div class="col-md-6">
            ...
            <div class="form-group">
                <?= Html::submitButton('Добавить размер', ['class' => 'btn btn-success']) ?>
