...
Полностью переработанная дизайн-система с модульной CSS архитектурой. Чёрно-белый минимализм, полная доступность, production-ready.

**Что нового в v4.0:**
- ✅ Модульная CSS архитектура (5 файлов)
- ✅ Design tokens в отдельном файле
- ✅ Утилитарные классы для быстрой разработки
- ✅ Полная поддержка Dark mode
- ✅ Устранены все hardcoded цвета
...
└── app.css          # Основные стили (legacy)
```

### Порядок подключения в AppAsset
1. **design-tokens.css** - переменные и токены (подключается первым)
2. **components.css** - кнопки, карточки, формы, модалы
3. **pages.css** - главная, каталог, карточка товара, корзина, checkout
4. **utilities.css** - утилитарные классы для быстрой разработки
5. **app.css** - основные стили (совместимость)

### Преимущества модульной архитектуры
- **Масштабируемость:** Легко добавлять новые компоненты
- **Поддержка:** Чёткое разделение ответственности
- **Производительность:** Оптимальная загрузка через версионирование
- **Разработка:** Быстрая разработка с утилитарными классами
